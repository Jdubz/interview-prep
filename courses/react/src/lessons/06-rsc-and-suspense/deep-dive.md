# Deep Dive: RSC Internals & Advanced Patterns

## Table of Contents

1. [RSC Wire Protocol (Flight)](#rsc-wire-protocol-flight)
2. [Partial Prerendering (PPR)](#partial-prerendering-ppr)
3. [Server Actions Internals](#server-actions-internals)
4. [ISR vs SSG vs SSR vs Streaming SSR](#isr-vs-ssg-vs-ssr-vs-streaming-ssr)
5. [Edge Rendering](#edge-rendering)
6. [React cache() and Dedupe Patterns](#react-cache-and-dedupe-patterns)
7. [Composition Patterns](#composition-patterns)
8. [Migration: Pages Router to App Router](#migration-pages-router-to-app-router)
