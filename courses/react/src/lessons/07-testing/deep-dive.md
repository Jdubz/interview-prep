# Lesson 07 Deep Dive: Advanced Testing Topics
...
- **Responsive snapshots**: Configure viewports in Chromatic/Percy to catch layout breakage across screen sizes.
...
it('does not re-render child when unrelated parent state changes', async () => {
  ...
  // This depends on your Profiler granularity
